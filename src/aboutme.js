...
const AboutMe = () => {
    return (
        <div className="description">
            <p>I am a front-end web developer for hire from Orange County, CA with experience in HTML, CSS, Javascript, ReactJS, NodeJS, ExpressJS, MongoDB, MongooseJS, and Git/GitHub. To see some of the work I've done you can go to my <a href="https://github.com/spencercorwin">GitHub</a> or click <Link to="/projects">here</Link> to see my completed projects.</p>
